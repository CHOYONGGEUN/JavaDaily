package javaplus.lamdaexpression.ex02;
...
public class FunctionToLamdaExpression {
    public static void main(String[] args) {
        ...
        A a3 = ()->System.out.println("입력 X 리턴 X 함수"); //중괄호 삭제 가능 (한줄 명령일때만 가능)//#1. 입력 X 리턴 X
       ...
       //#2. 입력 O 리턴 X
        ...
        B b5 = (a)->System.out.println("입력 O 리턴 X 함수");//입력 매개변수가 하나인 경우 소괄호도 생략 가능
